...
# Build the Netflow and IPFIX index in Elasticsearch
...
"Incoming Destination MAC OUI":         {"type":"string","index":"not_analyzed"},
"Incoming Source MAC":                  {"type":"string","index":"not_analyzed"},
"Incoming Source MAC OUI":              {"type":"string","index":"not_analyzed"},
...
"Outgoing Destination MAC OUI":         {"type":"string","index":"not_analyzed"},
"Outgoing Source MAC":                  {"type":"string","index":"not_analyzed"},
"Outgoing Source MAC OUI":              {"type":"string","index":"not_analyzed"},
